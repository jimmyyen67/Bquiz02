...
<body>
	...
	<div id="all">
		<div id="title">
			<?php
			echo Date("m") . " 月 " . Date("d") . " 號 " . Date("l") . " | 今日瀏覽: " . $total['total'] . " | 累積瀏覽: " . $alltotal[0][0] . "";
			?>
		...
		<div id="mm">
			...
			<div class="hal" id="main">
				<div>
					<marquee behavior="" direction="" style="width:80%; display:inline-block;">
					...
					?>
						<!-- 尚未登入 -->
						<span style="width:18%; display:inline-block" class="ct">
							<a href="?do=login">會員登入</a>
						</span>
					<?php
					} else if ($_SESSION['login'] == "admin") {
						$user = $User->find(['acc' => "admin"]);
					?>
						<!-- 登入者 == admin -->
						<span style="width:18%; display:inline-block" class="ct">
							歡迎，<?= $user['acc'] ?>
					...
					<?php
					$file = (empty($_GET['do'])) ? "main.php" : $_GET['do'] . ".php";
