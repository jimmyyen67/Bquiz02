...
<div class="">
  <div id="tag1" class="tag tagon" onclick="show(1)">健康新知</div>
  <div id="tag2" class="tag" onclick="show(2)">菸害防制</div>
  <div id="tag3" class="tag" onclick="show(3)">癌症防治</div>
  <div id="tag4" class="tag" onclick="show(4)">慢性病防治</div>
  <div id="post1" class="post" style="display:block">
    <h2>健康新知</h2>
    <pre>
